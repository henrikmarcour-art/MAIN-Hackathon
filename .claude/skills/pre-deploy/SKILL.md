...
2. **Before starting `npm run build`, tell the user.** Use a time limit and never leave a hung process running. If it stalls (usually an iCloud-synced clone; see Known issues in `AGENTS.md`), rely on the Vercel preview build.
